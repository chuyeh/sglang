...
# XPU is excluded on purpose: its own fused GDN path diverts before this gate.
_gdn_decode_fused_proj_conv = (_is_cuda or _is_hip) and (
    envs.SGLANG_ENABLE_GDN_DECODE_FUSED_PROJ_CONV.get()
)
